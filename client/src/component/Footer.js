...
import "../Styles/Footer.css"; // استيراد ملف CSS
        ...
        <Row>
          ...
          <Col md={4} className="text-left mb-4 mb-md-0">
            ...
            <p className="footer-text">
              ...
              services to students and staff. We are committed to enhancing the
              daily performance of our clients by maintaining their health.
            </p>
          </Col>
