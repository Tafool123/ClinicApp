...
import "../Styles/AboutUs.css"; // تأكد من إنشاء ملف CSS مخصص
        ...
        <div className="bodyteam">
          ...
          <div className="team-members">
            ...
            <div className="team-member-box">
              ...
              <h5>Website Designer & Coordinator</h5>
              <p>
                {" "}
               
Tafool Kashoob is a creative website designer and coordinator dedicated to enhancing the user experience of the university clinic platform. Her work focuses on crafting intuitive layouts and maintaining a consistent, user-friendly design that ensures easy access to health services for all students and staff....
              </p>
            </div>
          </div>
        </div>
