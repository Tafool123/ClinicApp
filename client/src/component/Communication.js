...
import "../Styles/Communication.css"; // تأكد من أن هذا الملف موجود في مجلد src
...
const Communication = () => {
  ...
  return (
    <Container  className="communication-container ">
      
      <div className="intro-section text-center mb-5">
  <h1 className="section-title">Communication & Support</h1>
  <div className="section-underline"></div>

  <div className="animated-paragraphs">
    <p className="fade-in-left">
      <strong>Effective communication and reliable support</strong> are at the
      heart of our university clinic's operations. We provide seamless channels
      for students, staff, and faculty to connect with healthcare professionals,
      ensuring their concerns are heard and addressed promptly.
    </p>
    ...
    <p className="fade-in-left">
      ...
      appointments, accessing health information, and addressing emergencies.
      At the university clinic, we are committed to creating a supportive
      environment where everyone feels cared for and empowered to prioritize
      their well-being.
    </p>
  </div>
</div>
